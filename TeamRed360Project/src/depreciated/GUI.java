...
public class GUI extends JFrame {
	...
	public void start() {
		...
		about.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent theEvent) {
				JOptionPane.showMessageDialog(GUI.this, constructNames(), "About", JOptionPane.INFORMATION_MESSAGE,
						new ImageIcon("images/strawberry-icon.png"));
			}
		});
		aboutTab.add(about);
		...
		allUsers.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(final ActionEvent theEvent) {
				JOptionPane.showMessageDialog(GUI.this, SQL.getAllUsers(), "All Users",
			...
			public void actionPerformed(final ActionEvent theEvent) {
				...
				if (code == 0) {
					...
					if (reply == JOptionPane.YES_OPTION) {
						...
						JOptionPane.showMessageDialog(GUI.this, "Please use the sign up tab.", "",
					...
					JOptionPane.showMessageDialog(GUI.this, "Incorrect password - try again..", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(GUI.this, "Error - could not access the login server.", "Error",
							JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent theEvent) {
				if (!password.getText().equals(passwordConfirm.getText())) {
					JOptionPane.showMessageDialog(GUI.this, "Passwords do not match.", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else {
					...
					if (code == 0) {
						...
						JOptionPane.showMessageDialog(GUI.this, "This email is already registered.", "Error",
								JOptionPane.ERROR_MESSAGE);
					} else {
						JOptionPane.showMessageDialog(GUI.this, "Error - could not access the login server.", "Error",
								JOptionPane.ERROR_MESSAGE);
	 ...
	 * 
	 * @return A string representation of all the contributor names, to be shown
	 *         in the "about" panel.
	 */
